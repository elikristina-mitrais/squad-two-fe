...
import { addNewTruck } from '../store/actions/transporter'
...
class AddTruck extends Component {
  ...
  submitData = (e) => {
    ...
    this.props.addNewTruck(licenseNumber, truckType, plateType, productionYear, stnk, kir)
  }
...
const mapDispatchToProps = { addNewTruck }

export default connect(null, mapDispatchToProps)(AddTruck)